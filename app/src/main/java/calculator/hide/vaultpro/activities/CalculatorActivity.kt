...
import calculator.hide.vaultpro.config.SecretFormulaConfig
import calculator.hide.vaultpro.ui.launcher.HomeLauncherActivity
import calculator.hide.vaultpro.ui.launcher.PrivateAppManagerActivity
import calculator.hide.vaultpro.ui.launcher.PrivateDesktopActivity

/**
 * Calculator Activity - Main entry point
 * Hidden trigger: Enter vault code then long press "=" for 2 seconds to unlock vault
 * Launcher formulas: see [SecretFormulaConfig]
 */
