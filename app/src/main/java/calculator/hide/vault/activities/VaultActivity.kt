...
import calculator.hide.vault.fragments.FilesFragment
import calculator.hide.vault.fragments.PhotosFragment
import calculator.hide.vault.fragments.VideosFragment
import calculator.hide.vault.security.PinManager
...
class VaultActivity : AppCompatActivity() {
    ...
    private var pendingImportMode: calculator.hide.vault.import.SafImporter.ImportMode = calculator.hide.vault.import.SafImporter.ImportMode.MOVE
        ...
        val dialog = MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("OK") { _, _ ->
                val mode = if (selectedModeIndex == 0) {
                    calculator.hide.vault.import.SafImporter.ImportMode.MOVE
                } else {
                    calculator.hide.vault.import.SafImporter.ImportMode.IMPORT
                }
    ...
    fun requestDeleteConfirmation(uri: Uri) {
        ...
        val safImporter = calculator.hide.vault.import.SafImporter(this, calculator.hide.vault.security.CryptoManager(this))
